          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start mb-12">
            ...
            <div className="animate-fade-in">
              ...
              <div className="space-y-4">
                <div className="relative flex items-start gap-4 bg-white rounded-xl p-5 border-2 border-deep-wine/30 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_8px_30px_-8px_hsl(348_70%_24%/0.25)]" style={{ boxShadow: '0 4px 20px -6px hsl(348 70% 24% / 0.15)' }}>
                  <span className="absolute top-3 right-3 bg-[hsl(var(--hero-accent))] text-white text-[10px] font-semibold px-2.5 py-0.5 rounded-full shadow-sm">Patented Technology</span>
      ...
      <section className="py-16 bg-secondary">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {[
              { name: 'Prof. Parag Bhargava', img: founderParag, role: 'Co-Founder' },
              ...
              >
                ...
                <p className="text-sm font-semibold text-accent mt-1">{founder.role}</p>
              </div>
            ))}
          </div>
        </div>
