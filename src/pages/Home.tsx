          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start mb-12">
            ...
            <div className="animate-fade-in">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed max-w-xl mb-8">
                AnyD Material is a <span className="font-semibold text-foreground">SINE <span className="text-[hsl(var(--hero-accent))]">IIT Bombay</span> incubated</span> startup founded by <span className="font-semibold text-foreground">IIT Researchers</span> & Professors <span className="font-semibold text-foreground">Dr. Seema & Dr. Shweta</span> and <span className="font-semibold text-foreground">Dr. Parag Bhargava</span>. Mentored by IITians who believe <em>curiosity + tech = future-ready kids</em>.
              </p>
